...
캠페인은 5개 스테이지, 60개 구역으로 구성되며 각 스테이지의 6번째 구역에 중간보스, 12번째 구역에 진 보스가 배치됩니다. 중간보스는 쇄우·적린·육화·공문·대역-13이고 진 보스는 철각·홍련·백면·무명·잔영-00입니다.

v1.9.0부터 적린은 샷건 반사막, 육화는 위치 교환, 공문은 검기, 대역-13은 포션·독가스를 사용합니다. 철각은 붉은 중장갑 지휘기와 원격 판넬 패턴으로 변경됐습니다. 하단의 일반 힌트 상자는 표시하지 않으며, 첫 화면에서 현재 버전과 이어하기 도달 스테이지를 확인할 수 있습니다.
